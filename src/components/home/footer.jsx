...
function Footer() {
  return (
    ...
    <div class="flex flex-wrap md:text-left text-center order-first">
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full h-fit bg-violet-400 p-8 rounded-xl">
        <h2 class="title-font font-bold text-black tracking-widest text-sm mb-3">SUBSCRIBE</h2>
