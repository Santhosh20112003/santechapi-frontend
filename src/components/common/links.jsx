...
export const random_profile_img = "https://source.unsplash.com/random/1000x800/?nature";
export const random_login_img = "https://source.unsplash.com/random/1000x800/?login";
export const random_register_img = "https://source.unsplash.com/random/1000x800/?signup";
...
export const apilist = [
  ...
  {
  name: "Random User",
  short_desc: "An API to get information about a random fake user, including gender, name, email, address, etc.",
  ...
  {
  name: "Dictionary",
  short_desc: "An API for fetching English word meaning, definitions, audio, etc.",
