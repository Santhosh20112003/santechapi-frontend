...
import { random_register_img } from '../common/links';
...
function Register() {
  ...
  return (
	<div className='flex h-[100vh] w-full flex-row-reverse'>
      <Link to="/home" className='fixed active:scale-105 transition-transform  px-3.5 py-2 top-5 right-5 rounded-full shadow-lg
     bg-violet-500 w-fit h-fit'>
      ...
      <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            ...
            <a href="/login" className="font-semibold leading-6 text-violet-600 hover:text-violet-500"> Login</a>
          </p>
        </div>
      </div>
      <div className="hidden overflow-y-hidden lg:block w-1/2 h-full">
        <img src={random_register_img}  alt="banner" className="brightness-75 w-100  h-full object-cover" />
      </div>
    </div>
  )
}
